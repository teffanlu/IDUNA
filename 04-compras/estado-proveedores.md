...
- Registro SAPI en **Clase 10** (aparatos) → la aparatología puede ir bajo marca propia; el **gel/skincare NO** (van como reventa de marcas reconocidas — confirmar clase con abogado).
- Modelo: skincare revendido (gancho/flujo) + aparatología marca propia (margen) + educación (diferenciador).
- Capital real disponible ~$2,625. El margen está en los aparatos, no en el skincare.

## Logística (definida)
- Agencia con **casillero en China** (ya usada, consolida varios proveedores en un envío). Tránsito marítimo **60-70 días**.
- Mínimo **0.15 CBM** para enviar (se puede más, paga más flete).
- **NO pedir muestras sueltas**: irían por marítimo y romperían el calendario. Seguro alternativo = Trade Assurance + proveedor sólido + cantidad conservadora + **1-2 uds de respaldo en el pedido** (el reemplazo por garantía es inútil con 60-70 días de tránsito).
- Comprar en **julio** → llegar en septiembre/octubre → lanzar en **Q4 navideño**.
- **Ruta USA (skincare + gel):** casillero Miami (agencia Rudy). Es rápida → se ejecuta cuando el pedido China esté EN VÍA. Detalle en `sourcing-skincare-usa.md`.

## Costo de aterrizaje (regla)
Costear SIEMPRE sobre el producto puesto en Maracaibo, no sobre el precio Alibaba:
`(precio unit + flete interno China + flete marítimo prorrateado por CBM + aduana + casillero) / unidades`
Producto pequeño/liviano aprox. +$7-10/u de costos. **Objetivo de margen del aparato: >55%.**
...
### 4. Cryo sticks — DIFERIDO a Fase 2
...
## Arquitectura de kits (precios corregidos — todo kit con galvánico vende $95+, NO $55)
...
**Orden de incorporación:** Lote 1 = micro-accesorios · **Fast-follow** = espátula ultrasónica ($3-5, ojo solapa con ION+) · **Fase 2** = cepillo silicona, cryo, máscara LED.
...
## ⏰ Fecha tope para pedir en Alibaba (crítica)
Cuenta regresiva (tránsito 70 días) desde "listo para vender ~1 nov":
